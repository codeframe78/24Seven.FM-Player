...
- **Pre-Alpha features:** M24's service-owned Sleep Timer, M25's dedicated Android audio-output path, and M26's privacy-safe in-app diagnostics are complete. M25 intentionally leaves Google Cast gated behind verified receiver compatibility and permitted stream use. M27 adds opt-in station-scoped Chat-mention push notifications and will also notify for new Private Messages whenever M17 is repaired and enabled, without exposing a broken PM surface or imitating push with perpetual background polling.
