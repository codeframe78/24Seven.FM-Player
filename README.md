...
| M23.6 Release device matrix and pre-launch report | M | 3–6 hours | 🚧 Current-head local/physical matrix green ([evidence](docs/m23-device-compatibility.md)) | Emulator coverage passes across minimum API, API 36, 16 KB, Fold, and Tablet states; physical Razr playback and UI survive a measured open/tabletop/closed/reopened cycle. Play delivery/update and Play pre-launch results remain |
