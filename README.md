...
| M23.6 Release device matrix and pre-launch report | M | 3–6 hours | 🚧 Current-head local matrix green ([evidence](docs/m23-device-compatibility.md)) | Current-head 36/36 suites pass on minimum API, API 36, 16 KB runtime, Pixel Fold open, and Pixel Tablet landscape; changed paths also pass after Fold half-open/closed and Tablet portrait transitions. Physical Razr hinge, Play delivery/update, and Play pre-launch results remain |
