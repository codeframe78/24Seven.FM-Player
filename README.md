...
- **Completed:** M1–M16, all five station certifications (M18–M22), M23.3 Android 16 / API 36 readiness, M23.7 adaptive launcher/store polish, M24 Sleep Timer, and M25 Audio-Output Selection.
...
- **Pre-Alpha features:** M24's service-owned Sleep Timer and M25's dedicated Android audio-output path are complete. M25 intentionally leaves Google Cast gated behind verified receiver compatibility and permitted stream use. M26 adds privacy-safe in-app diagnostics, and M27 adds opt-in station-scoped Chat-mention push notifications. M27 will also notify for new Private Messages whenever M17 is repaired and enabled, without exposing a broken PM surface or imitating push with perpetual background polling.
