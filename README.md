...
| Milestone | Size | Estimate | Status | Outcome |
| --- | --- | --- | --- | --- |
| M23 Alpha distribution readiness | M | 1–2 focused days | 🚧 In progress | Play assets/declarations, modern-device tests, protected upload signing, and signed-candidate validation are green; off-PC key backup, public privacy hosting, reviewer/audience/contact details, and tester setup remain |
...
M23 is active on this branch. The Google Play developer account and app record are established, Play App Signing is selected, the no-ads/non-government/no-financial/no-health declarations are saved, Play-ready graphics and device screenshots are prepared, compact/medium/expanded Android layouts are validated, and the protected upload-signed APK/AAB pass cryptographic and emulator smoke validation. Remaining dependencies are an off-PC upload-key recovery backup, a stable public privacy URL, audience/contact/reviewer details, tester setup, Play upload/delivery verification, and explicit publication authorization.
