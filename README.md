...
| M23.6 Release device matrix and pre-launch report | M | 3–6 hours | 🚧 Accessibility/network/device checkpoints green ([evidence](docs/m23-device-compatibility.md)) | Emulator coverage passes across minimum API, API 36, 16 KB, Fold, and Tablet states; large-text reflow, one-shot network restoration, and physical Razr hinge testing pass. Play delivery/update and Play pre-launch results remain |
