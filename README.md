...
| Milestone | Size | Estimate | Status | Outcome |
| --- | --- | --- | --- | --- |
| M23 Alpha distribution readiness | M | 1–2 focused days | 🚧 In progress | Play assets/declarations, modern-device and foldable tests, notification/library/Favorites hardening, protected signing/recovery, public privacy hosting, contact/category setup, and signed-candidate validation are green; reviewer credentials, audience/content declarations, tester setup, and Play-delivery verification remain |
