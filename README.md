...
- **Planned before Alpha publication:** M24 adds a service-owned Sleep Timer; M25 adds Cast and/or dedicated audio-output selection after route discovery; M26 adds privacy-safe in-app diagnostics; and M27 adds opt-in station-scoped Chat-mention push notifications. M27 will also notify for new Private Messages whenever M17 is repaired and enabled, without exposing a broken PM surface or imitating push with perpetual background polling.
- **Project documentation:** The GitHub Pages [project portal](https://codeframe78.github.io/24Seven.FM-Player/project/) now connects the product, architecture, development process, testing evidence, roadmap, and contributor resources while preserving the canonical privacy-policy URL ([validation and screenshots](docs/project-portal-validation.md)).
...
| M24 Sleep Timer | M | 3–5 hours | ⏳ Planned after M23 | Add a service-owned countdown with start, adjust, cancel, expiry, notification/UI state, and lifecycle-safe playback stop behavior |
