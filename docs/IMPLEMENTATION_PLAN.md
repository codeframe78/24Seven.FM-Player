...
| M23.6 Release device matrix and pre-launch report | M, current-head local/physical matrix green | 3–6 hours | Medium | Emulator coverage passes across API 26, API 36, 16 KB, Fold, and Tablet states; physical Razr playback/UI survive a measured open/tabletop/closed/reopened cycle. Complete Play delivery/update and pre-launch remediation | Play crawler/delivery access |
