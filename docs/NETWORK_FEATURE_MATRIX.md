...
| Contact and membership links | Contact + VIP | Contact + VIP | Contact + VIP | Contact + RIP | Contact + VIP | Native directory only | Browser-dependent | Some destinations | Legacy HTML | Exact allowlisted Custom Tab | Current shipped catalog | Browser and protected app sessions remain separate |
