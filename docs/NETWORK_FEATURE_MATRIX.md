...
| Membership/VIP status | VIP verified | VIP unverified | VIP unverified | RIP unverified | VIP unverified | Yes if reliably exposed | Yes | N/A | Profile-scoped legacy HTML | Custom Tab for purchase/manage | SST implemented in M15 | Explicit badge only; administrative rank never implies membership; never transfer status across stations |
